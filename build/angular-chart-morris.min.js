...
(function () {
    ...
    /**
     * @ngdoc object
     * @name angular.morris.chart.factory
     * @description
     * Utility functions
     **/
    angular.module('angular.morris.chart').factory('angularMorris', /*@ngInject*/ function angularMorris($injector) {
        var s = {
            /**
...
/* global Morris */
(function () {
    angular.module("angular.morris.chart").directive('barChart', /*@ngInject*/function (angularMorris) {
        ...
        return {
            restrict: 'A',
            scope: angularMorris.populateScopeDefinition({ barLabels: '=' , barColors: '=', barX: '@', barY: '=' }, 'bar', OPTION_KEYS),
            link: function (scope, elem) {
                scope.$watchCollection('barLabels', function (newData, oldData) {
                    if(!scope.barInstance) return
                    scope.barInstance.options.labels = newData;
                    setData(scope.barData)
                })
                scope.$watchCollection('barColors', function (newData, oldData) {
                    if(!scope.barInstance) return
                    scope.barInstance.options.barColors = newData;
                    setData(scope.barData)
                })
                scope.$watchCollection('barY', function (newData, oldData) {
                    if(!scope.barInstance) return
                    scope.barInstance.options.ykeys = newData;
                    setData(scope.barData)
                })
                ...
                function setData(data){
                    scope.barInstance.setData(data);
                }
            }
        }
    })
...
/* global Morris */
(function() {
    angular.module("angular.morris.chart").directive('donutChart', /*@ngInject*/function(angularMorris) {
...
/* global Morris */
(function () {
    angular.module("angular.morris.chart").directive('lineChart', /*@ngInject*/function (angularMorris) {
        ...
        return {
            restrict: 'A',
            scope: angularMorris.populateScopeDefinition({ lineColors: '=', parseTime: '=', lineXkey: '=', lineYkeys: '=', lineLabels: '='  }, 'line', OPTION_KEYS, 'xkey', 'ykeys', 'colors', 'labels'),
            link: function (scope, elem) {
                scope.$watchCollection('lineLabels', function (newData, oldData) {
                ...
                scope.$watchCollection('lineColors', function (newData, oldData) {
                    if(!scope.lineInstance) return
                    scope.lineInstance.options.barColors = newData;
                    setData(scope.lineData)
                })
